...
[![CI](https://github.com/namequalsmain/REPO_NAME/actions/workflows/ci.yml/badge.svg)](https://github.com/namequalsmain/REPO_NAME/actions/workflows/ci.yml)
...
```bash
# 1. Clone
git clone https://github.com/namequalsmain/REPO_NAME.git
cd REPO_NAME
